...
import com.example.ivic.parking.bluetooth.BluetoothSerialClient;
import com.example.ivic.parking.bluetooth.BluetoothSerialClient.*;
...
import static com.example.ivic.parking.R.id.vac1;

public class OpenVac extends Activity {
    ...
    private BluetoothStreamingHandler mBTHandler = new BluetoothStreamingHandler() {
        ...
        public void onData(byte[] buffer, int length) {
            ...
            if(buffer[length - 1] == '\0') {
                ...
                {
                    bt1 = (Button)findViewById(R.id.vac1);
